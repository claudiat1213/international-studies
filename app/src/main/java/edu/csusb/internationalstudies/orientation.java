    ...
    private void addDrawerItems() {
        ...
        mDrawerList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    Intent intent = new Intent(orientation.this, aboutCisp.class);
                    startActivity(intent);
                } else if (position == 1){
                    Intent intent = new Intent(orientation.this, secondAdvise.class);
                    startActivity(intent);
                }else if (position == 2) {
                    Intent intent = new Intent(orientation.this, admissionsInfo.class);
                    startActivity(intent);
                }else if (position == 3) {
                    Intent intent = new Intent(orientation.this, StudyAbroad.class);
                    startActivity(intent);
                }else if (position == 4) {
                    Intent intent = new Intent(orientation.this, exchangeProgram.class);
                    startActivity(intent);
                }else if (position == 5){
                    Intent intent = new Intent(orientation.this, otherResources.class);
                    startActivity(intent);
                }
            }
        });
